...
**Vet Clinic Database** is a relational database focus project. Users can use the project query to create, read, update and delete specific data form the database using sql terminal.
