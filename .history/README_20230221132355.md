...
**Vet Clinic Database** is a relational database focus project. Through this project, users can query to create, read, update and delete specific data form the database using sql terminal.
